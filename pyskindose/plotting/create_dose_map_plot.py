...
def create_dose_map_plot(patient: Phantom, settings: PyskindoseSettings, dose_map: np.ndarray) -> None:
    ...
    fig.write_html("R:/Radiotherapie/99-Services et Unites/05 Service de Physique/00 Rep-Perso 2016/DQPRM_2024_imagerie/RI/Fiche_RX_06/Donnee_HEGP_DoseCutanée_QI/Dose cutanée/DoseMap.html")
